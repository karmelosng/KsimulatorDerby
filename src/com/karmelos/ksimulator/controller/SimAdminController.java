...
public class SimAdminController extends SimController{
   ...
   private static String baseUrl = "jdbc:derby://localhost:1527/ksimulator";
//           "jdbc:mysql://host:3306/ksimulator?zeroDateTimeBehavior=convertToNull";

    public SimAdminController() {
        Map LocalProperty = new HashMap();
        LocalProperty.put("hibernate.show_sql", true);
        LocalProperty.put("hibernate.connection.url", baseUrl.replaceAll("localhost", "127.0.0.1"));
