...
import static com.badlogic.gdx.graphics.Mesh.transform;
...
public class ObjectTest extends BaseG3dHudTest {
        protected Environment environment;
        private List<SimComponent> preCached;
        private List<SimComponent> newComponents;
        private Map<SimComponent,ModelInstance> instance = new HashMap<SimComponent,ModelInstance>();
    private boolean showup;
    public ObjectTest(boolean showupToggle,List<SimComponent> pre){
     showup = showupToggle;
     preCached =pre;
	...
	public void create () {
		...
		cam.update();
		showAxes = true;
              // loadAllScenes(preCached);
		onModelClicked("obj_2.g3db");
	}
...
//                }
		...
		animationControllers.clear();
               ModelInstance instance=null;
                if(showup){
                    ...
                    instances.add(this.instance.get(newComponents.get(i)));
                    }
	...
	public boolean keyUp (int keycode) {
		...
		return super.keyUp(keycode);
         ...
         public List<SimComponent> getPreCached() {
        return preCached;
    }

    public void setPreCached(List<SimComponent> preCached) {
